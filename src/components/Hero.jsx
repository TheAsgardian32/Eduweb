        ...
        <section id="home" className=' bg-orange-50 h-[600px] '>
            <div className='flex lg:flex-row flex-col items-center justify-center p-5 lg:max-w-7xl mx-auto relative'>
                ...
                <div className='lg:w-1/2 w-[275px]  relative'>
                    ...
                    <div variant="outline" className='bg-red-50 gap-1 text-lg flex border-red-200 border  items-center absolute bottom-16 right:58 lg:right-14 px-4 py-2 rounded-full'>
                    ...
                    <div variant="outline" className=' flex flex-col bg-red-50 border-red-200 border px-0 py-1 lg:px-6 lg:py-2 absolute top-20 left-44 lg:top-16 lg:left-24  rounded-full items-center lg:w-[150px] w-[150px]'>
